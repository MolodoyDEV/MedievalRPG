...
namespace QuantumTek.QuantumQuest
{
    ...
    public class QQ_Task
    {
        ...
        [HideInInspector] public UnityEvent TaskCompleted = new UnityEvent();
        [HideInInspector] public UnityEvent ProgressIncreased = new UnityEvent();
